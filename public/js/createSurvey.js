...
function oldSelect(value,index){
if(value == "text"){
    document.getElementById('oldMultipleChoice'+index).style.display = 'none';
    document.getElementById('oldCheckbox'+index).style.display = 'none';
} else if (value == "multiple-choice"){
    document.getElementById('oldMultipleChoice'+index).style.display = 'block';
    document.getElementById('oldCheckbox'+index).style.display = 'none';
} else {
    document.getElementById('oldMultipleChoice'+index).style.display = 'none';
    document.getElementById('oldCheckbox'+index).style.display = 'block';
}
}
...
$(document).on('click', '.addOptionCheckbox', function(){
        $(this).parent().parent().prepend('<div class="checkbox"> <label> <input type="checkbox" value="">Checkbox <input class="form-control" name = "checkbox'+this.id+'[]" ></label><span class = "input-group-btn"><button class="removeOption btn btn-danger" id ="">Remove Option</button></span></div>');
    });

$(document).on('click', '.addOldOptionCheckbox', function(){
        $(this).parent().parent().prepend('<div class="checkbox"> <label> <input type="checkbox" value="">Checkbox <input class="form-control" name = "oldCheckbox'+this.id+'[]" ></label><span class = "input-group-btn"><button class="removeOption btn btn-danger" id ="">Remove Option</button></span></div>');
    });

$(document).on('click', '.addOptionRadio', function(){
        $(this).parent().parent().prepend('<div class="radio"> <label> <input type="radio" value="">Option <input class="form-control" name = "radio'+this.id+'[]" ></label><span class = "input-group-btn"><button class="removeOption btn btn-danger" id ="">Remove Option</button></span></div>');
    });

$(document).on('click', '.addOldOptionRadio', function(){
        $(this).parent().parent().prepend('<div class="radio"> <label> <input type="radio" value="">Option <input class="form-control" name = "oldRadio'+this.id+'[]" ></label><span class = "input-group-btn"><button class="removeOption btn btn-danger" id ="">Remove Option</button></span></div>');
    });
