...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">DETAIL APPRAISAL</h1>
            </div>
                            ...
                            <form class = "form-horizontal" role="form">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeA">
                                            ...
                                            <td><input type="radio" name="answer[{{$question->id}}]"  value="{{$i}}" checked disabled></td>
                                            @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class = "col-md-12">
                                        ...
                                        <textarea class="form-control" name = "comment" disabled />{{$appraisal->comment}}</textarea>
                                        @else
